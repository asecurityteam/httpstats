...
func (r *fixturePusher) Push(target string, opts *http.PushOptions) error {
	r.calledPush = true
	return nil
}
...
func TestFancyWriter2CloseNotify(t *testing.T) {
	var base = fixtureResponseWriter{}
	var wrapped = fixtureHTTPResponseWriter{
		base,
		fixtureHijacker{base, false},
...
func TestFancyWriter2Flush(t *testing.T) {
	var base = fixtureResponseWriter{}
	var wrapped = fixtureHTTPResponseWriter{
		base,
		fixtureHijacker{base, false},
...
func TestFancyWriter2Push(t *testing.T) {
	var base = fixtureResponseWriter{}
	var wrapped = fixtureHTTPResponseWriter{
		base,
		fixtureHijacker{base, false},
